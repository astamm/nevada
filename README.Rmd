...
[![Codecov test coverage](https://codecov.io/gh/astamm/nevada/graph/badge.svg)](https://app.codecov.io/gh/astamm/nevada)
...
```{r}
withr::with_seed(1234, {
  t1_global <- nevada::test2_global(x, y)
})
t1_global$pvalue
```
...
```{r}
withr::with_seed(1234, {
  t1_local <- nevada::test2_local(x, y, partition)
})
t1_local
```
